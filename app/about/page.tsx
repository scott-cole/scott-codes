      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Frontend', skills: ['React & Next.js', 'TypeScript', 'Performance Optimization', 'State Management'] },
              { title: 'Architecture', skills: ['Scalable Systems', 'Design Systems', 'Code Quality', 'Testing'] },
              { title: 'Leadership', skills: ['Team Management', 'Code Reviews', 'Mentoring', 'Technical Strategy'] },
              { title: 'Modern Tech', skills: ['Vite & Next.js', 'Tailwind CSS', 'CI/CD', 'Cloud Deploy'] },
            ].map((group, index) => (
              <Reveal key={group.title} delay={index * 100}>
                <div className="card p-6">
                  <h3 className="text-lg font-display font-semibold text-white mb-4">{group.title}</h3>
